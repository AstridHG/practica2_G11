...
public class ListaCurso {
    ...
    public String editarPorPosicion(int posicion , int id, String nombre,int nota){
        ...
        if(posicion>=0 && posicion<tamanio){
            ...
            if(posicion == 0){
                ...
                inicio.setValor(id, nombre,nota);
            }
            else{
    ...
    public String removerPorPosicion(int posicion){
        ...
        if(posicion>=0 && posicion<tamanio){
            ...
            // o sea el ultimo
                ...
                NodoCurso siguiente = aux.getSig();
    ...
    for(int i=0;i<parts.length;i++){
        ...
        agregarAlFinal(Integer.parseInt(parts2[0]), parts2[1],Integer.parseInt(parts2[2]));
    } 
